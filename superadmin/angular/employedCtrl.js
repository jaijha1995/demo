app.controller('employedCtrl', function($scope, $http, $window, config) {
    ...
    $scope.list = function(req, res) {
        console.log(config.baseurl);
        $http.get(config.baseurl + 'employed/')
    ...
    $scope.add = function(req, res) {
        ...
        if (typeof $scope.data.id == 'undefined') {
            // alert($scope.data.id);
            $http.post(config.baseurl + 'employed/', $scope.data)
                .success(function(res) {
                    if (res.status == 'false') {} else {
            ...
            // alert($scope.data.id);
            $http.patch(config.baseurl + 'employed/', $scope.data)
                .success(function(res) {
                    if (res.status == 'false') {} else {
                        $scope.response = res.data;
                        console.log('message: ', $scope.response);
    ...
    $scope.update = function(id) {
        $http.get(config.baseurl + 'employed/' + id)
            .success(function(res) {
                if (res.status == 'false') {} else {
                    $scope.data = res.data;
    ...
    $scope.delete = function(id) {
        $http.delete(config.baseurl + 'employed/' + id)
            .success(function(res) {
                if (res.status == 'false') {} else {
                    $scope.response = res.data;
